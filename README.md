...
- **[PRD.md](docs/PRD.md)** – Product Requirements Document s detailními požadavky
- **[stav_aplikace.md](docs/stav_aplicace.md)** – Aktuální stav implementace

## 📅 Historie verzí

| Verze | Datum | Popis |
|-------|-------|-------|
| 1.0 | 2024 | První verze PRD a prototyp |
| 1.1 | 26.2.2026 | Návrhy změn (viz docs/APPKA PORG - navrhy zmen k 26.2.2026.docx) |
